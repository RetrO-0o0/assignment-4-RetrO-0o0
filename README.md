...
$ cat base_external/Config.in
source "$BR2_EXTERNAL_project_base_PATH/package/aesd-assignments/Config.in"

$ cat base_external/external.desc
name: project_base
desc: Base external tree for AESD assignments

$ cat base_external/external.mk
include $(sort $(wildcard $(BR2_EXTERNAL_project_base_PATH)/package/*/*.mk))

$ cat base_external/package/aesd-assignments/Config.in
...
3. Running QEMU and logging in to the machine
--------------------------------------------------------------------------------
...
4. Presence of writer, finder.sh, finder-test.sh and writer.sh in /usr/bin
--------------------------------------------------------------------------------
...
5. Running finder-test.sh from /root directory, results and /var/log/messages
--------------------------------------------------------------------------------
# finder-test.sh
...
Logs recorded in /var/log/messages:
